...
def plot_lstm2layer_output(a,modulation_type=None,save_filename='E:/shiyan/CNN2/CNN2/figure/save_filename/'):
...
def plot_conv4layer_output(a,modulation_type=None):
    ...
    for i in range(100):
        ...
        plt.xticks([])  #去掉横坐标值
        plt.yticks(size=20)
        save_filename='./E:/shiyan/CNN2/CNN2/figure/output%d.png'%i
        plt.savefig(save_filename,dpi=600,bbox_inches='tight')
        plt.tight_layout()
        plt.close()
 

def plot_confusion_matrix(cm, title='Confusion matrix', cmap=plt.get_cmap("Blues"), labels=[],save_filename='E:/shiyan/CNN2/CNN2/figure/save_filename'):
    plt.figure(figsize=(4, 3),dpi=600)
